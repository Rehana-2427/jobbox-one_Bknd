...
public class ChatController {
	...
	//
	// // Optionally, you can add logic here to send the saved message back to
	// clients
	//
	// return savedMessage;
	// }
...
//	}
	...
	@PutMapping("/updateChatMsg")
	public ResponseEntity<?> updateChatMessage(@RequestParam Long chatId, @RequestBody Chat updatedChat) {
		chatService.updateChatMessage(chatId, updatedChat);

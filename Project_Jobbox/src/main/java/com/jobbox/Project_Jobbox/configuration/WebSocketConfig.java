...
//		config.setUserDestinationPrefix("/user");
	...
	public void registerStompEndpoints(StompEndpointRegistry registry) {
		...
		registry.addEndpoint("/api/jobbox/ws").setAllowedOriginPatterns("http://51.79.18.21:3000", "http://localhost:3000","http://jobbox.one") // Allow all origins, adjust as needed
